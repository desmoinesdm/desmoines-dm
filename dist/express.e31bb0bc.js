  ...
  function addHeaderBorder() {
    if (window.pageYOffset > 300) {
      ...
      adj.forEach(function (e) {
        return e.classList.add("adjust");
      });
    } else {
      header.classList.remove("header-box-shadow");
      adj.forEach(function (e) {
        return e.classList.remove("adjust");
      });
    }
    ...
    if (window.pageYOffset > appsOffset) {
      ...
      // headerButton.classList.add("btn-primary-2");
      headerButton.classList.remove("btn-sec"); // headerImgTwo.classList.remove("display-none");

      headerImgThree.classList.add("display-none"); // sandwich.classList.add("fourth-color");
      // sandwich.classList.remove("sec-color");
...
//# sourceMappingURL=/express.e31bb0bc.js.map